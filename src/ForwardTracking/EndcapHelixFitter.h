#ifndef EndcapHelixFitter_h
#define EndcapHelixFitter_h
...
class EndcapHelixFitterException : public std::exception {
...
public: 
   virtual ~EndcapHelixFitterException() throw() { /*no_op*/; } 
...
private:
   ...
   void fit()throw( EndcapHelixFitterException );
